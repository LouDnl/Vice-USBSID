...
/* SIDEXTENDED (for usbsid engine) snapshot module format:
...
// static int sid_snapshot_read_us_module(snapshot_module_t *m, int sidnr, uint8_t vmajor, uint8_t vminor)
// {
//     sid_us_snapshot_state_t sid_state;
...
// #ifdef HAVE_USBSID  // TODO: CHECK AND FINISH
//         case SID_ENGINE_USBSID:
//             if (sid_snapshot_read_us_module(m, sidnr, major_version, minor_version) < 0) {
//                 goto fail;
//             }
//             break;
// #endif
